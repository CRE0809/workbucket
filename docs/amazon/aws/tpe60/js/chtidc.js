...
async function copyPages(dateStart,dateEnd,people) {
    ...
    firstDonorPage.drawText(`${String(new Date().getDate()).padStart(2, '0')}/${String(new Date().getMonth() + 1).padStart(2, '0')}/${new Date().getFullYear()}`, { x: 375, y: 730, size: 10, font: customFont, color: rgb(0,0,0)});
    firstDonorPage.drawText(`${dateStart} ~ ${dateEnd}`, { x: 152, y: 600, size: 10, font: customFont, color: rgb(0,0,0)});
